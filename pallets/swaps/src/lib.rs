...
impl<T: Config> Module<T> {
	...
	{
		let numerator = input_reserve * output_amount * 1000_u32.into();
		let denominator = (output_reserve - output_amount) * 997_u32.into();
		numerator / denominator + 1_u32.into()
	}
	...
	{
		let input_amount_with_fee = input_amount * 997_u32.into();
		let numerator = input_amount_with_fee * output_reserve;
		let denominator = (input_reserve * 1000_u32.into()) + input_amount_with_fee;
